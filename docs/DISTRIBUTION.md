...
This repository distributes the open local Skill and read-only MCP adapter. It contains no billing, entitlement, account, telemetry, cloud upload, or vendor-specific paid logic.
